...
export async function seedDatabase() {
  ...
  const seedServices = [
    ...
    },
    {
      ...
      description: "Hand-painted balayage or precision foil highlights for a natural, sun-kissed look. Includes toner and conditioning treatment.",
      duration: 150,
      price: "225.00",
      category: "Hair",
      imageUrl: "/images/service-color.png",
    ...
    },
    {
      ...
      description: "Intensive hydration therapy that restores moisture, repairs damage, and leaves your hair incredibly soft and manageable.",
      duration: 45,
      price: "55.00",
      category: "Hair",
      imageUrl: "/images/service-hair.png",
    ...
    },
    {
      ...
      description: "Nail shaping, cuticle care, hand massage, and your choice of polish for beautifully groomed nails.",
      duration: 30,
      price: "35.00",
      category: "Nails",
      imageUrl: "/images/service-nails.png",
      isActive: true,
    },
    {
      name: "Gel Manicure",
      description: "Long-lasting gel polish application with nail shaping and cuticle care. Chip-resistant shine for up to two weeks.",
      duration: 45,
      price: "50.00",
      category: "Nails",
      imageUrl: "/images/service-nails.png",
    ...
    {
      name: "Luxury Facial",
      description: "A restorative facial featuring deep cleansing, exfoliation, customized mask, facial massage, and premium serums for glowing skin.",
      duration: 75,
      price: "120.00",
      category: "Facial",
      imageUrl: "/images/service-facial.png",
      isActive: true,
    },
    {
      name: "Express Facial",
      description: "Quick refresh facial with cleansing, light exfoliation, hydrating mask, and moisturizer for an instant glow.",
      duration: 30,
      price: "65.00",
      category: "Facial",
      imageUrl: "/images/service-facial.png",
